<template>
  <div class="relative" dir="rtl">
    ...
    >
      <!--
      <div class="hero-pano" role="img" aria-label="»‰— Œœ„«  ê” —‘ ”—ÊÌ”">
...
usePageSeo({
  title: "„⁄—›Ì",
  description: "ê” —‘ ”—ÊÌ” ó ”«„«‰Â? «” ⁄·«„ Ê÷⁄Ì  Ê ‘—«Ìÿ ê«—«‰ Ì »—‰œÂ«",
...
const actionCards: ActionCard[] = [
  {
    title: "«” ⁄·«„ ›Ê—Ì ê«—«‰ Ì",
    description:
      "‘„«—Â ”—Ì«· œ” ê«Â —« À»  ò‰Ìœ Ê ‰ ÌÃÂ «” ⁄·«„ —« œ— ·ÕŸÂ „‘«ÂœÂ ò‰Ìœ.",
    to: "/warranty/check",
  ...
  },
  {
    title: "‘—«Ìÿ »—‰œÂ«",
    description:
      "„œ  Ê ‘—«Ìÿ ê«—«‰ Ì Â— »—‰œ —« »Â  ›òÌò œ” Âù»‰œÌ Ê „Õ’Ê·«  »——”Ì ò‰Ìœ.",
    to: "/warranty/policies",
  ...
  },
  {
    title: "¬„Ê“‘ Ê »·«ê",
    description:
      "‰ò«  ò«—»—œÌ »—«Ì «—”«· œ” ê«Â° ‰êÂœ«—Ì »Â — Ê  «“Âù —Ì‰ «Œ»«— Œœ„«  —« »ŒÊ«‰Ìœ.",
    to: "/education",
...
const showcaseCards = [
  {
    title: "ÅÌ‘ŒÊ«‰ ‰„«Ì‰œêÌ",
    description:
      "œ—Ì«›   Ìò ùÂ«Ì ÃœÌœ° „œÌ—Ì  ﬁÿ⁄«  Ê „‘«ÂœÂ Ê÷⁄Ì  Â— ”›«—‘ œ— Ìò œ«‘»Ê—œ „ „—ò“.",
  ...
  },
  {
    title: "« Ê„«”ÌÊ‰  ⁄„Ì—ê«Â",
    description:
      "À»  ›—¬Ì‰œ Å–Ì—‘  « „—ÃÊ⁄Ì œ” ê«Â »« ›—„ùÂ«Ì ÂÊ‘„‰œ Ê «ÿ·«⁄ù—”«‰Ì ŒÊœò«— »Â „‘ —Ì.",
  ...
  },
  {
    title: "ê“«—‘ùÂ«Ì  Õ·Ì·Ì",
    description:
      "—Ê‰œ Œ—«»Ì „Õ’Ê·« ° ﬁÿ⁄«  Å— ò—«— Ê ⁄„·ò—œ  Ì„ùÂ«Ì Œœ„«  —« »« ‰„Êœ«—Â«Ì œ«Ì‰«„Ìò »»Ì‰Ìœ.",
